...
namespace _230417_TeamGitHub
{
    ...
    public class MissNpc : Non_Player_Character
    {
        public MissNpc(string name) : base(name)
        {
            string str = "허허허....";
            string str1 = "아이구...허리야...";
            string str2 = "누가 이 늙은이좀 도와줬으면 하는데...";
    ...
    public class YouthNpc : Non_Player_Character
    {
        public YouthNpc(string name) : base(name)
        {
            string str = "허허허....";
            string str1 = "아이구...허리야...";
            string str2 = "누가 이 늙은이좀 도와줬으면 하는데...";
